...
async def Comments(link,envir):
    if envir=="uat":
        ...
        moreReviews=driver.find_element(By.XPATH,'//*[@id="reviews-medley-footer"]/div[2]/a', '_29bd')
        ...
        dropDown=driver.find_element(By.XPATH,'//*[@id="a-autoid-5-announce"]' , '_29bd')
        dropDown.click()

        dropDownElements=driver.find_element(By.ID,"star-count-dropdown_0" , '_29bd')
        ...
        #         break
            ...
            #extracting summary 
        summary=[]
        summarys=driver.find_elements(By.XPATH,'//*[@class="a-section review aok-relative"]/div/div/div[2]/a/span[2]', '_29bd')
